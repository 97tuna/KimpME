...
[바이낸스](https://binance.com/ko)시세와 [업비트](https://upbit.com), [빗썸](https://www.bithumb.com/), [코인원](https://coinone.co.kr/)의 실시간 시세를 받아와 차액을 계산하여 각 코인당 김치 프리미엄 가격을 표기
...
## 개발 상황
 ...
 - ❗️**중요** 업비트, 빗썸, 코인원 거래 코인 최신화 완료 (2021.09.05)
 - **현재 앱 출시를 위한 상세페이지 제작 중** (2021.09.06 ~ )
<br>
 ...
 * 앱을 좀 더 다듬어서 앱스토어에 퍼블리싱 하는것이 목표! <br>
 현재 아쉬운 디자인과 색상 배치는 다크모드시에 눈이 아픈 경향이 있음. (iOS 15에서 systemMint지원은 아쉽다)
